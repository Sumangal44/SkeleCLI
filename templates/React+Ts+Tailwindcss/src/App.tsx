    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-zinc-800 p-6 transition-all">
      ...
      <div className="flex flex-wrap justify-center gap-6 mb-6">
        <a href="https://vite.dev" target="_blank">
          <img
            src={viteLogo}
            className="w-28 md:w-24 lg:w-28 transition-all hover:scale-110 logo  "
            alt="Vite logo"
          />
        </a>
        <a href="https://react.dev" target="_blank">
          <img
            src={reactLogo}
            className="w-28 md:w-24 lg:w-28 transition-all hover:scale-110  logo react "
            alt="React logo"
          />
        </a>
        <a href="https://tailwindcss.com" target="_blank">
          <img
            src={tailwind}
            className="w-28 md:w-24 lg:w-28 transition-all hover:scale-110 logo tailwind "
        ...
        <a href="https://typescriptlang.org" target="_blank">
          <img
            src={typescript}
            className="w-28 md:w-24 lg:w-28 transition-all hover:scale-110 logo typescript "
            alt="TypeScript logo"
          />
        </a>
      </div>
      ...
      <p className="mt-6 text-gray-600 dark:text-gray-300 text-center transition-all">
        Click on the Vite, React, and Tailwind logos to learn more. create by{' '}
        <a
          href="https://github.com/Sumangal44/SkeleCLI.git"
